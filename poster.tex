...
structure conservation.  The example below from \cite{Nawrocki13b}
...
%\section*{Modelling secondary structure improves Infernal and Rfam: tools for automated RNA genome annotation}
%\begin{Large}
...
\caption{
Results on our internal RMARK benchmark. Plots are shown for the new
Infernal 1.1 with and without filters, for
profile HMM searches with nhmmer (from the HMMER package included in
...
by Howard Hughes Medical Institute (EPN, SRE), by the European
